...
/*    '        <li class="set-option">'+
    ...
    '      <ul class="find-ul">'+
    '        <li class="find-list">'+
    '                <a href="https://www.zhihu.com"><img src="img/zhihu.com.png"><p>知乎</p><p>知识分享社区</p></a>'+
    '                <a href="http://36kr.com"><img src="img/36kr.png"><p>36kr</p><p>互联网创业资讯</p></a>'+
    '                <a href="http://sspai.com"><img src="img/sspai.png"><p>少数派</p><p>高质量应用推荐</p></a>'+
    '                <a href="http://www.ifanr.com"><img src="img/ifanr.png"><p>爱范儿</p><p>范科技媒体</p></a>'+
    '                <a href="http://www.zealer.com"><img src="img/zealer.com.png"><p>ZEALER</p><p>电子产品评测网站</p></a>'+
    '                <a href="http://www.dgtle.com"><img src="img/dgtle.png"><p>数码尾巴</p><p>分享美好数字生活</p></a>'+
    ...
    '        <li class="find-list">'+
    '           '+
    '                <a href="http://m.douban.com"><img src="img/douban.png"><p>豆瓣</p><p>一个神奇的社区</p></a>'+
    '                <a href="http://qingmang.me/magazines"><img src="img/qingmang.png"><p>轻芒杂志</p><p>生活兴趣杂志</p></a>'+
    '                <a href="http://m.wufazhuce.com"><img src="img/wufazhuce.com.png"><p>ONE</p><p>韩寒监制</p></a>'+
    '                <a href="http://m.mafengwo.cn"><img src="img/mafengwo.png"><p>马蜂窝</p><p>旅游攻略社区</p></a>'+
    '                <a href="http://m.xiaohongshu.com"><img src="img/xiaohongshu.png"><p>小红书</p><p>可以买到国外的好东西</p></a>'+
    '                <a href="http://m.smzdm.com"><img src="img/smzdm.png"><p>什么值得买</p><p>应该能省点钱吧</p></a>'+
    '                <a href="https://dianying.taobao.com"><img src="img/taopiaopiao.png"><p>淘票票</p><p>不看书，就看几场电影吧</p></a>'+
    '                <a href="http://m.xiachufang.com"><img src="img/xiachufang.png"><p>下厨房</p><p>是男人就学做几道菜</p></a>'+
    '                <a href="https://enjoy.ricebook.com"><img src="img/enjoy.png"><p>ENJOY</p><p>高端美食团购</p></a>'+
    '                <a href="http://www.o2bra.com.cn"><img src="img/o2bra.png"><p>氧气</p><p>帮她挑一件性感bra</p></a>'+
    '        </li>'+
    '        <li class="find-list">'+
    '                <a href="http://m.zcool.com.cn"><img src="img/zcool.png"><p>站酷网</p><p>设计师互动平台</p></a>'+
    '                <a href="http://www.lofter.com"><img src="img/lofter.png"><p>Lofter</p><p>摄影爱好者社区</p></a>'+
    '                <a href="http://www.behance.net"><img src="img/behance.png"><p>Behance</p><p>Adobe旗下的创意平台</p></a>'+
    '                <a href="https://dribbble.com"><img src="img/dribbble.png"><p>Dribbble</p><p>好设计都在这</p></a>'+
    '                <a href="http://www.uisdc.com"><img src="img/uisdc.png"><p>优设网</p><p>设计从业者入门网站</p></a>'+
    '                <a href="http://miniature-calendar.com"><img src="img/miniature-calendar.png"><p>小型日历</p><p>脑洞无限巨大</p></a>'+
    '                <a href="https://thefwa.com"><img src="img/thefwa.png"><p>thefwa</p><p>网页界的奥斯卡</p></a>'+
    '                <a href="https://500px.com"><img src="img/500px.png"><p>500px</p><p>最出色的摄影社区</p></a>'+
    '                <a href="http://m.moko.cc"><img src="img/moko.png"><p>MOKO!</p><p>娱乐人才平台</p></a>'+
    '        </li>'+
    '        <li class="find-list">'+
    '                <a href="http://www.wandoujia.com/award"><img src="img/wandoujia.png"><p>豌豆荚设计</p><p>发现最优美的应用</p></a>'+
    '                <a href="http://m.ximalaya.com"><img src="img/xmlyfm.png"><p>喜马拉雅听</p><p>音频分享平台</p></a>'+
    '                <a href="http://www.coolapk.com"><img src="img/coolapk.png"><p>酷安</p><p>发现应用的乐趣</p></a>'+
    ...
    $(".set-option").click(function() {
        ...
        }else if($(".set-option").eq(i).find('p').html()==="删除壁纸和LOGO")
        {
            ...
            Storage.set[3][1]=Storage.set[Storage.set[3][0]]="./img/logo.png";
            localStorage.setItem("set", JSON.stringify(Storage.set));
